...
const Education = () => {
    return (
        <div id="edu" className="mt-28 container mx-auto mb-10">
             <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold border-l-4 pl-4 border-orange-600">Education</h2>
             <div className="mt-20">
  ...
  <li>
    ...
    <div className="timeline-start timeline-box border-2 border-orange-600">
      <p className="text-2xl font-bold  text-orange-600">BACHELOR DEGREE</p>
       <h2> October 2021 - Present | Green University Of Bangladesh</h2>
    </div>
    <div className="timeline-middle ">
    ...
    <h2 className="text-justify">Currently pursuing a Bachelor's degree in Computer Science and Engineering (CSE) at Green University of Bangladesh, entering my last year.Actively involved in hands-on projects and extracurricular activities, aiming to apply this education to drive innovation in technology.</h2>
    </div>
