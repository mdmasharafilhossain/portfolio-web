...
const Experience = () => {
    return (
        <div id="exp" className="mt-20 container mx-auto mb-10">
  ...
  <li>
    ...
    <span className="text-7xl text-orange-600 border" ><MdAssuredWorkload className="border-2 border-orange-600  p-2 rounded-full"/></span>
