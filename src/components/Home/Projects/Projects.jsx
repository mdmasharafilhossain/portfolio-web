      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col md:flex-col lg:flex-row gap-20">
          ...
          <div className="flex-1">
            <div className="flex  gap-2 text-3xl">
              <span className="mt-1">
                <SlControlForward className="text-orange-600" />
              </span>
        ...
        <div className="flex mt-20 flex-col md:flex-col lg:flex-row gap-20">
          ...
          <div className="flex-1 mt-3">
            ...
            <h2 className="ml-10 text-xl text-justify mt-2">
              This is Travel website .If User can travel any of the Bangladesh
              he can do it using this website. User can full details of the
              place. User can also see our guides. User can book place where
              he/she wish to travel. User also see details.User can also see
              his/her bookings.
            </h2>
            ...
            <div className="flex md:gap-16 lg:justify-between mt-5">
              ...
              <div className="flex  text-orange-600  gap-1 text-2xl p-1 ml-10 font-bold">
                ...
                <a href="https://github.com/mdmasharafilhossain/tour-and-travel-client">
                  Client Side
                </a>
              </div>
              <div className="flex  text-orange-600 gap-1 text-2xl p-1 ml-10 font-bold">
                ...
                <a href="https://github.com/mdmasharafilhossain/tour-and-travel-server">
                  Server Side
                </a>
              </div>
            </div>
          ...
          {/*Project  4 */}
            <div className="flex mt-20 flex-col md:flex-col lg:flex-row gap-20">
              ...
              <div className="flex-1 mt-7">
                ...
                <h2 className="ml-10 text-xl text-justify mt-2">
                  This is Tech Shop website. User can buy many smart things here
                  like computer, phone , smart watch. user also see his/her
                  bookings. User can see full details of those things before
                  buying .User also see our customer review
                </h2>
                <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-6 gap-20 mt-10 ml-10 text-2xl">
                  <img className="w-10" src={html} alt="" />
                  <img className="w-12" src={css3} alt="" />
                ...
                <div className="flex md:gap-16 lg:justify-between mt-7">
                  ...
                  <div className="flex  text-orange-600  gap-1 text-2xl p-1 ml-10 font-bold">
                    ...
                    <a href=" https://github.com/mdmasharafilhossain/tech-shop-web">
                      Client Side
                    </a>
                  </div>
                  <div className="flex  text-orange-600 gap-1 text-2xl p-1 ml-10 font-bold">
                    ...
                    <a href="https://github.com/mdmasharafilhossain/tech-shop-web-server">
                      Server Side
                    </a>
                  </div>
                </div>
