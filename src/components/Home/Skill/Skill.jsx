...
const Skill = () => {
    return (
        <div id="skill" className="mt-20 container mx-auto">
            ...
            <div>
            <div className="radial-progress text-orange-700 " style={{"--value":90}} role="progressbar">90%</div>
            <h1 className="ml-4 font-bold mt-1">HTML</h1>
            </div>
            <div>
            <div className="radial-progress text-orange-700 " style={{"--value":60}} role="progressbar">60%</div>
            ...
            <div>
            <div className="radial-progress text-orange-700 " style={{"--value":70}} role="progressbar">70%</div>
            <h1 className="ml-4 font-bold mt-1">REACT</h1>
            </div>
            <div>
            <div className="radial-progress text-orange-700 " style={{"--value":50}} role="progressbar">50%</div>
            ...
            <div>
            <div className="radial-progress text-orange-700 " style={{"--value":80}} role="progressbar">80%</div>
